...
target_include_directories(lvgl SYSTEM PUBLIC ${LVGL_ROOT_DIR} ${LV_CONF_DIR} ${LVGL_ROOT_DIR}/../ ${LVGL_ROOT_DIR}/../../ ${LV_CONF_CUSTOM_PATH})
...
if(NOT LV_CONF_BUILD_DISABLE_THORVG_INTERNAL)
    ...
    target_include_directories(lvgl_thorvg SYSTEM PUBLIC ${LVGL_ROOT_DIR}/src/libs/thorvg ${LVGL_ROOT_DIR}/../ ${LVGL_ROOT_DIR}/../../ ${LV_CONF_CUSTOM_PATH})
...
if(NOT LV_CONF_BUILD_DISABLE_EXAMPLES)
    ...
    target_include_directories(lvgl_examples SYSTEM PUBLIC ${LVGL_ROOT_DIR}/examples ${LVGL_ROOT_DIR}/../ ${LVGL_ROOT_DIR}/../../ ${LV_CONF_CUSTOM_PATH})
...
if(NOT LV_CONF_BUILD_DISABLE_DEMOS)
    ...
    target_include_directories(lvgl_demos SYSTEM PUBLIC ${LVGL_ROOT_DIR}/demos ${LVGL_ROOT_DIR}/../ ${LVGL_ROOT_DIR}/../../ ${LV_CONF_CUSTOM_PATH})
