 ...
 *  Desc: jpeg register define(v2)
 */

#ifndef JPEG_REGISTER_V2_H
#define JPEG_REGISTER_V2_H
...
typedef struct
{
	unsigned mode : 2;    //0-normal; 1-partial; 2-clip
	unsigned wresp : 1;
...
typedef struct
{
	unsigned req_num : 2; // [1:0]: mcu number parallel, 0-1 mcu number,...,3-4 mcu number
	unsigned buf_num : 3;  // disp buffer number
	unsigned r : 11;
	unsigned slice_num : 16;
} reg_buf_num;
