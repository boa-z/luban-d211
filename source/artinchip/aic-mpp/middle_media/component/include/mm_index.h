...
typedef enum MM_INDEX_TYPE {
    ...
    MM_INDEX_CONFIG_TIME_FORCE_SYNC_AUDIO_REFERENCE,
    ...
    MM_INDEX_CONFIG_GIVEBACK_ALL_FRAME,
    ...
    MM_INDEX_VENDOR_STORAGE_HANDLE,
} MM_INDEX_TYPE;
