...
static int setup_reloc(void)
{
	...
	log_notice("Relocation Offset is: 0x%08lx\n", gd->reloc_off);
	log_notice("Relocating to 0x%08lx, new gd at 0x%08lx, sp at 0x%08lx\n",
...
static int jump_to_copy(void)
{
	...
	/* RISCV jump to board_init_r after relocation, don't come back here. */
#endif
