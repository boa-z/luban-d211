...
const struct flash_info spi_nor_ids[] = {
	...
	},
	{
		INFO("gd25q256", 0xc84019, 0, 64 * 1024, 512,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK |SPI_NOR_4B_OPCODES | SPI_NOR_HAS_TB)
	},
	{
	...
	{
		INFO("gd25q127c", 0xc84018, 0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB)
	},
#endif
	...
	{ INFO("w25q256jwf", 0xef8019, 0, 64 * 1024, 512, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
