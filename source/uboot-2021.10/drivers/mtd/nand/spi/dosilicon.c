...
#define DS35X1GAXXX_STATUS_ECC_1_7_BITFLIPS	(1 << 4)
#define DS35X1GAXXX_STATUS_ECC_8_BITFLIPS	(3 << 4)

#define DS35X1GAXXX_REG_STATUS2		0x0f
...
static int ds35x1gaxxx_variant2_ooblayout_ecc(struct mtd_info *mtd, int section,
...
static int ds35x1gaxxx_variant2_ooblayout_free(struct mtd_info *mtd, int section,
					struct mtd_oob_region *region)
{
	if (section)
		return -ERANGE;
...
static const struct mtd_ooblayout_ops ds35x_variant2_ooblayout = {
	.ecc = ds35x1gaxxx_variant2_ooblayout_ecc,
	.rfree = ds35x1gaxxx_variant2_ooblayout_free,
};
...
{
	u8 status2;
	struct spi_mem_op op = SPINAND_GET_FEATURE_OP(DS35X1GAXXX_REG_STATUS2,
						      &status2);
	int ret;
	...
	case DS35X1GAXXX_STATUS_ECC_1_7_BITFLIPS:
		/*
	...
	case DS35X1GAXXX_STATUS_ECC_8_BITFLIPS:
		return 8;
...
static const struct spinand_info dosilicon_spinand_table[] = {
	SPINAND_INFO("DS35X1GAXXX",
		     ...
		     SPINAND_HAS_QE_BIT,
		     SPINAND_ECCINFO(&ds35x_variant2_ooblayout,
