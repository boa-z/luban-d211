...
struct di_funcs {
	...
	s32 (*set_videomode)(struct fb_videomode *vm, int enable);
...
struct aic_panel_callbacks {
	...
	int (*di_set_videomode)(struct fb_videomode *vm, int enable);
	int (*timing_enable)(void);
};
...
struct aic_panel_funcs {
	...
	int (*get_video_mode)(struct aic_panel *panel, struct fb_videomode *vm);
